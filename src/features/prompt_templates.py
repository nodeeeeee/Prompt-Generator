...
def get_one_shot_template(
    ...
    insight_section = f"\n# ARCHITECTURAL DIRECTIVES & TECHNICAL INSIGHTS\n{project_context}" if project_context else ""
...
def get_iterative_long_form_template(
    ...
    insight_section = f"\n# CODEBASE INSIGHTS & INTEGRATION CONSTRAINTS\n{project_context}" if project_context else ""
...
## CORE REQUIREMENTS & SYSTEMIC CONTEXT
...
def get_detailed_cot_template(
    ...
    insight_section = f"\n# DEEP TECHNICAL INSIGHTS & ARCHITECTURAL ANCHORS\n{project_context}" if project_context else ""
...
# SYSTEMIC CONTEXT & TECHNICAL ANCHORS
...
# ARCHITECTURAL INSIGHTS & INTEGRATION PROTOCOL
